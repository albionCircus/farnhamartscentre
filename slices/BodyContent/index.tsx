...
const BodyContent: FC<BodyContentProps> = ({ slice }) => {
  return (
    <Bounded as='section' className="flex justify-center flex-col w-full lg:max-w-[1300px] margin0auto BodyContent" data-slice-type={slice.slice_type} data-slice-variation={slice.variation}>
