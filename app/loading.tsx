    ...
    return (
        <section className="flex justify-center my-14">
            ...
            <div className='flex space-x-2 justify-center items-center bg-white dark:invert h-2/6'>
                ...
                <div className='h-8 w-8 bg-charcoal rounded-full animate-bounce [animation-delay:-0.3s]'></div>
                <div className='h-8 w-8 bg-charcoal rounded-full animate-bounce [animation-delay:-0.15s]'></div>
                <div className='h-8 w-8 bg-charcoal rounded-full animate-bounce'></div>
            </div>
        </section>
    )
  }